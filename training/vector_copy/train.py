...
data_filename = data_path + "/curOpLatencyCollect_Vector_Copy.csv"
model_filename = model_path + "/Vector_Copy.model"
...
header = lines[0]
if header != "Vector_Copy":
    raise ValueError("Data is not for copying vector. Please check the source file!!!")
