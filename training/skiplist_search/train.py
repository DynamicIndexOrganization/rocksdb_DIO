...
data_filename = data_path + "/curOpLatencyCollect_Skiplist_Search.csv"
model_filename = model_path + "/Skiplist_Search.model"
...
header = lines[0]
if header != "Skiplist_Search":
    raise ValueError("Data is not for searching in an SkipList. Please check the source file!!!")
